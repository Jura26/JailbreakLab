...
const attacks: Attack[] = [
   ...
   },
   {
      ...
      references: [
         "https://llm-attacks.org/ - Catalog of jailbreak prompts and attacks",
         "https://arxiv.org/abs/2307.02483 - 'Universal and Transferable Adversarial Attacks on Aligned Language Models'",
         "https://arxiv.org/abs/2302.04237 - 'Jailbroken: How Does LLM Safety Training Fail?'",
      ],
   },
   {
      ...
      references: [
         "https://arxiv.org/abs/2307.02483 - 'Universal and Transferable Adversarial Attacks on Aligned Language Models'",
         "https://deepmind.google/discover/blog/ai-safety-in-the-age-of-llms/ - High-level discussion of LLM misuse and safety",
      ],
   },
   {
      ...
      references: [
         "https://arxiv.org/abs/2304.05335 - 'More than you've asked for: A Comprehensive Analysis of Novel Prompt Injection Threats to Application-Integrated Large Language Models'",
         "https://www.microsoft.com/en-us/security/blog/2023/06/28/defending-against-ai-attacks/ - Microsoft Security blog on multi-turn and probing attacks",
      ],
   },
   {
      id: "fcb-bias_guided",
      ...
      references: [
         "https://arxiv.org/abs/2307.15043 - 'Universal and Transferable Adversarial Attacks on Aligned Language Models' (GCG method)",
         "https://arxiv.org/abs/2211.09527 - 'Ignore Previous Prompt: Attack Techniques for Language Models'",
      ],
   },
   {
      ...
      references: [
         "https://arxiv.org/abs/2402.11753 - 'ArtPrompt: ASCII Art-based Jailbreak Attacks against Aligned LLMs'",
         "https://research.ibm.com/blog/prompt-injection - Overview of prompt injection and obfuscation techniques",
      ],
   },
];
